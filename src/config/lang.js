export const tw = {
	...
	intro_1: '目前於KKday擔任新事業專案組前端工程師，已參與7+項全新且已上線之專案開發。工作內容包含負責點對點交通服務前端畫面處理、功能串接、通用元件設計、單元測試撰寫等。',
	...
	career_desc_kkday_1: '點對點服務PC / M前端開發, 參與7項以上全新之專案開發',
	career_desc_kkday_2: 'Web vitals優化, 設計模板開發, 通用元件設計',
	career_desc_kkday_3: '前後台系統維運, 單元測試撰寫',
